...
|696.82ms|./p068-magic-5-gon-ring/Cargo.toml|
|519.13ms|./p034-digit-factorials/Cargo.toml|
|497.91ms|./p070-totient-permutation/Cargo.toml|
|442.75ms|./p073-counting-fractions-in-a-range/Cargo.toml|
